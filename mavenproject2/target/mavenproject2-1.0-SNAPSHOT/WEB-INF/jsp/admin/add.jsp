...
<body>
    ...
    <center>
    <c:url var="addUser" value="/admin/add"></c:url>
    <form class="selectForm" action="${addUser}" method="POST" onsubmit="return control()">
        <table>
                <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/> <!-- bunu koyunca csrf np-->
                <tr>
                    <td>
    ...
    <c:if test="${!empty userDetails}">
        <table >
            ...
            <c:forEach var="us" items="${userDetails}" varStatus="status">
                <tr>
                    ...
                    <td><a href="<c:url value='/admin/edit/${us.username}'/>">Edit</a></td>
                    <td><a href="<c:url value='/admin/remove/${us.username}'/>">Remove</a></td>
                </tr>
            </c:forEach>
                <tr>
                    <th>Username</th>
                ...
                <c:forEach var="us" items="${userRolee}">
                    <tr>
